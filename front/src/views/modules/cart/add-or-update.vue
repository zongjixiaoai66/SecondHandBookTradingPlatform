            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='tushu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="出版社" prop="tushuChubanshe">
                        <el-input v-model="tushuForm.tushuChubanshe"
                ...
                <el-col :span="12"  v-if="sessionTable !='tushu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="图书原价" prop="tushuOldMoney">
                        <el-input v-model="tushuForm.tushuOldMoney"
                                  placeholder="图书原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='tushu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="tushuClicknum">
                        <el-input v-model="tushuForm.tushuClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="点击次数" prop="tushuClicknum">
                            <el-input v-model="ruleForm.tushuClicknum"
