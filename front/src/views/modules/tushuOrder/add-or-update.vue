    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实付价格" prop="tushuOrderTruePrice">
                       <el-input v-model="ruleForm.tushuOrderTruePrice"
                                 placeholder="实付价格" clearable  :readonly="ro.tushuOrderTruePrice"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="实付价格" prop="tushuOrderTruePrice">
                           <el-input v-model="ruleForm.tushuOrderTruePrice"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="tushuOrderTypes">
                        <el-select v-model="ruleForm.tushuOrderTypes" :disabled="ro.tushuOrderTypes" placeholder="请选择订单类型">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="订单类型" prop="tushuOrderValue">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="支付类型" prop="tushuOrderPaymentTypes">
                        <el-select v-model="ruleForm.tushuOrderPaymentTypes" :disabled="ro.tushuOrderPaymentTypes" placeholder="请选择支付类型">
                            <el-option
                                v-for="(item,index) in tushuOrderPaymentTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="支付类型" prop="tushuOrderPaymentValue">
                        <el-input v-model="ruleForm.tushuOrderPaymentValue"
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    ...
                    tushuOrderTruePrice: '',
                    tushuOrderTypes: '',
                    tushuOrderPaymentTypes: '',
                    insertTime: '',
                },
                tushuOrderTypesOptions : [],
                tushuOrderPaymentTypesOptions : [],
                addressOptions : [],
                tushuOptions : [],
                yonghuOptions : [],
                rules: {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=tushu_order_payment_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.tushuOrderPaymentTypesOptions = data.data.list;
                    }
                });
