                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/ershoushujiaoyipingtai/upload/tushuMuBan.xls"
                        >批量导入图书数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('tushu','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('tushu','修改')" type="primary" icon="el-icon-add-location" size="mini" @click="plusTushuKucunNumber(scope.row.id,scope.row.tushuKucunNumber)">增加库存</el-button>
                            <el-button v-if="isAuth('tushu','修改')" type="primary" icon="el-icon-delete-location" size="mini" @click="reduceTushuKucunNumber(scope.row.id,scope.row.tushuKucunNumber)">减少库存</el-button>
