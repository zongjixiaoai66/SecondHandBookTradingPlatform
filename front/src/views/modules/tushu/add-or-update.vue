    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="图书库存" prop="tushuKucunNumber">
                       <el-input v-model="ruleForm.tushuKucunNumber"
                                 placeholder="图书库存" clearable  :readonly="ro.tushuKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="图书原价" prop="tushuOldMoney">
                       <el-input v-model="ruleForm.tushuOldMoney"
                                 placeholder="图书原价" clearable  :readonly="ro.tushuOldMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="图书原价" prop="tushuOldMoney">
                           <el-input v-model="ruleForm.tushuOldMoney"
                                     placeholder="图书原价" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价" prop="tushuNewMoney">
                       <el-input v-model="ruleForm.tushuNewMoney"
                                 placeholder="现价" clearable  :readonly="ro.tushuNewMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="现价" prop="tushuNewMoney">
                           <el-input v-model="ruleForm.tushuNewMoney"
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   tushuOldMoney: [
                              { required: true, message: '图书原价不能为空', trigger: 'blur' },
